...
const datasets = {
  "morning-exercise": [
    ...
    { 日期: "2026-08-03", 姓名: "陈清禾", 学号: "20250018", 区队: "治安2601区队", 集合时间: "", 缺勤原因: "病假（已批）", 考勤状态: "请假" },
    { 日期: "2026-08-03", 姓名: "许星野", 学号: "20240136", 区队: "刑侦2501区队", 集合时间: "06:25", 缺勤原因: "无", 考勤状态: "正常" },
  ],
  "appearance-inspection": [
    { 检查日期: "2026-08-02", 姓名: "林晓晨", 学号: "20260001", 区队: "侦查2601区队", 检查项目: "着装与仪容", 扣分: "0", 检查结果: "合格", 检查人: "张卫国" },
    { 检查日期: "2026-08-02", 姓名: "周言川", 学号: "20260002", 区队: "侦查2601区队", 检查项目: "着装与仪容", 扣分: "2", 检查结果: "不合格", 检查人: "张卫国" },
    { 检查日期: "2026-08-02", 姓名: "沈知夏", 学号: "20250107", 区队: "治安2601区队", 检查项目: "内务与警容", 扣分: "0", 检查结果: "合格", 检查人: "李红梅" },
  ],
  "conduct-score": [
    { 记录日期: "2026-08-02", 姓名: "周言川", 学号: "20260002", 区队: "侦查2601区队", 加减分: "扣分", 事由: "警容风纪检查不合格", 分值: "2", 记录人: "张卫国" },
    { 记录日期: "2026-08-01", 姓名: "林晓晨", 学号: "20260001", 区队: "侦查2601区队", 加减分: "加分", 事由: "队列训练标兵", 分值: "3", 记录人: "张卫国" },
    { 记录日期: "2026-07-30", 姓名: "许星野", 学号: "20240136", 区队: "刑侦2501区队", 加减分: "加分", 事由: "执勤表现突出", 分值: "2", 记录人: "王强" },
  ],
  "conduct-score-stats": [
  ...
  "physical-test": [
    ...
    { 测试日期: "2026-07-20", 姓名: "许星野", 学号: "20240136", 区队: "刑侦2501区队", 测试项目: "1000米跑", 成绩: "3分42秒", 成绩评定: "优秀" },
    { 测试日期: "2026-07-20", 姓名: "沈知夏", 学号: "20250107", 区队: "治安2601区队", 测试项目: "800米跑", 成绩: "3分58秒", 成绩评定: "优秀" },
    { 测试日期: "2026-07-21", 姓名: "周言川", 学号: "20260002", 区队: "侦查2601区队", 测试项目: "引体向上", 成绩: "8个", 成绩评定: "及格" },
  ],
  "police-training": [
    { 训练日期: "2026-08-01", 训练科目: "队列训练", 姓名: "林晓晨", 学号: "20260001", 区队: "侦查2601区队", 考勤状态: "出勤", 备注: "无" },
    { 训练日期: "2026-08-01", 训练科目: "队列训练", 姓名: "陈清禾", 学号: "20250018", 区队: "治安2601区队", 考勤状态: "请假", 备注: "病假（已批）" },
    { 训练日期: "2026-08-02", 训练科目: "擒敌拳", 姓名: "许星野", 学号: "20240136", 区队: "刑侦2501区队", 考勤状态: "出勤", 备注: "无" },
  ],
  "duty-assignment": [
  ...
  "emergency-drill": [
    { 演练名称: "紧急集合演练", 演练类型: "紧急集合", 开展日期: "2026-07-15", 参与区队: "全体区队", 参与人数: "97", 完成用时: "4.5", 演练评价: "良好", 组织者: "学生处" },
    { 演练名称: "消防疏散演练", 演练类型: "消防疏散", 开展日期: "2026-06-20", 参与区队: "侦查2601区队、治安2601区队", 参与人数: "62", 完成用时: "6", 演练评价: "合格", 组织者: "保卫处" },
  ],
  "political-review": [
    { 姓名: "林晓晨", 学号: "20260001", 区队: "侦查2601区队", 审查类别: "入警资格审查", 提交日期: "2026-07-10", 审查意见: "政审材料齐全，审查通过", 审查状态: "已通过" },
    { 姓名: "周言川", 学号: "20260002", 区队: "侦查2601区队", 审查类别: "入警资格审查", 提交日期: "2026-07-12", 审查意见: "待补充家庭成员政审材料", 审查状态: "审查中" },
  ],
};
