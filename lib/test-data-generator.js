...
export function createTestDataset({ seed, featureIds, studentCount = 500, recordsPerFeature = 8 }) {
  ...
  const users = [
    { id: deterministicId("test-user", 0, random), username: "test_staff_01", displayName: "测试辅导员一", role: "staff" },
    { id: deterministicId("test-user", 1, random), username: "test_staff_02", displayName: "测试辅导员二", role: "staff" },
    { id: deterministicId("test-user", 2, random), username: "test_faculty", displayName: "测试院系管理员", role: "staff" },
    { id: deterministicId("test-user", 3, random), username: "test_dorm", displayName: "测试宿管员", role: "staff" },
    { id: deterministicId("test-user", 4, random), username: "test_viewer_01", displayName: "测试只读用户一", role: "viewer" },
    { id: deterministicId("test-user", 5, random), username: "test_viewer_02", displayName: "测试只读用户二", role: "viewer" },
  ];
